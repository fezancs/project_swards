...
export class ClientdashboardComponent implements OnInit {
  ...
  getcustomer() {
    this.clientinfo.getcustomer(this.env.user_email).subscribe(
      result => {
        console.log(result);
  ...
  getinvoice() {
    this.clientinfo.getinvoice(this.env.user_email).subscribe(
      result => {
        console.log(result);
  ...
  getorder() {
    this.clientinfo.getorder(this.env.user_email).subscribe(
      result => {
        console.log(result);
  ...
  updatecustomer() {
    ...
    this.model.email = this.env.user_email;
